...
import com.example.party_lojo_game.ui.vo.AddNewAskState.Companion.CONTENT_ALLREADY_SAVED_VALUE
...
sealed class AddNewAskState {
    ...
    companion object {
        const val CONTENT_ALLREADY_SAVED_VALUE = "ya existe en la base de datos"
    }
}
...
enum class AddNewAsKErrorsType(var value: String) {
    ...
    CONTENT_ALLREADY_SAVED(value = CONTENT_ALLREADY_SAVED_VALUE),
    UNKNOWN(value = "")
}
