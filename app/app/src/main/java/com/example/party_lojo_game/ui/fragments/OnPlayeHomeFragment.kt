...
class OnPlayeHomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        players.players.forEachIndexed{ index, playerBO ->
            when (index) {
                0 -> {
                    binding.fragmentOnPlayHomePlayer1.setImageDrawable(getImage(playerBO.resource, context))
                ...
                1 -> {
                    binding.fragmentOnPlayHomePlayer2.setImageDrawable(getImage(playerBO.resource, context))
                ...
                2 -> {
                    binding.fragmentOnPlayHomePlayer3.setImageDrawable(getImage(playerBO.resource, context))
                ...
                3 -> {
                    binding.fragmentOnPlayHomePlayer4.setImageDrawable(getImage(playerBO.resource, context))
                ...
                4 -> {
                    binding.fragmentOnPlayHomePlayer5.setImageDrawable(getImage(playerBO.resource, context))
                ...
                5 -> {
                    binding.fragmentOnPlayHomePlayer6.setImageDrawable(getImage(playerBO.resource, context))
                ...
                6 -> {
                    binding.fragmentOnPlayHomePlayer7.setImageDrawable(getImage(playerBO.resource, context))
                ...
                7 -> {
                    binding.fragmentOnPlayHomePlayer8.setImageDrawable(getImage(playerBO.resource, context))
                ...
                8 -> {
                    binding.fragmentOnPlayHomePlayer9.setImageDrawable(getImage(playerBO.resource, context))
                ...
                9 -> {
                    binding.fragmentOnPlayHomePlayer10.setImageDrawable(getImage(playerBO.resource, context))
                    binding.fragmentOnPlayHomePlayer10.visibility = View.VISIBLE
                    binding.fragmentOnPlayHomePlayer11.visibility = View.GONE
                    binding.fragmentOnPlayHomePlayer12.visibility = View.GONE
                }
                10 -> {
                    binding.fragmentOnPlayHomePlayer11.setImageDrawable(getImage(playerBO.resource, context))
                    binding.fragmentOnPlayHomePlayer11.visibility = View.VISIBLE
                    binding.fragmentOnPlayHomePlayer12.visibility = View.GONE
                }
                11 -> {
                    binding.fragmentOnPlayHomePlayer12.setImageDrawable(getImage(playerBO.resource, context))
